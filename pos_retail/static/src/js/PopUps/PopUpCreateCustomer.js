odoo.define('pos_retail.PopUpCreateCustomer', function (require) {
    ...
    class PopUpCreateCustomer extends AbstractAwaitablePopup {
        ...
        mounted() {
            super.mounted()
            const self = this
            // TODO: get format datetime filter by lang selected
            // const lang = this.env.pos.lang_selected
            // let date_format = lang.date_format.replaceAll('%', '')
            // date_format = date_format.replaceAll('M', 'MM')
            // date_format = date_format.replaceAll('m', 'MM')
            // date_format = date_format.replaceAll('D', 'DD')
            // date_format = date_format.replaceAll('d', 'DD')
            // date_format = date_format.replaceAll('Y', 'YYYY')
            // date_format = date_format.replaceAll('y', 'YYYY')
